...
const mock = readFileSync('/tmp/shots/mock_talk_trusted.html','utf8');

const ctx = await chromium.launchPersistentContext('/tmp/shots/profileTALK2',{headless:false,
...
await page.screenshot({path:`${OUT}/tt-solving.png`});
