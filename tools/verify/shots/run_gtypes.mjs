...
const mock = readFileSync('/tmp/shots/mock_gtypes.html','utf8');
const ctx = await chromium.launchPersistentContext('/tmp/shots/profileGTYPES',{headless:false,
...
await page.screenshot({path:`${OUT}/gtypes.png`});
await ctx.close();
