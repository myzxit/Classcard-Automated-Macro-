...
const mock = readFileSync('/tmp/shots/mock_gmatch.html','utf8');
const ctx = await chromium.launchPersistentContext('/tmp/shots/profileGMATCH',{headless:false,
...
await page.screenshot({path:`${OUT}/gmatch.png`});
await ctx.close();
