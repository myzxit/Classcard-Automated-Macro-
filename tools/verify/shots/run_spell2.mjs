...
const ctx = await chromium.launchPersistentContext('/tmp/shots/profileSPELL2',{headless:false,
...
await popup.click('.mode-btn[data-id="spell"]');
await popup.waitForTimeout(150);
await popup.click('#btnRun');

await page.bringToFront();
await page.waitForTimeout(6000);
await page.screenshot({path:`${OUT}/spell2-solving.png`});
