...
const mock = readFileSync('/tmp/shots/mock_gmulti.html','utf8');
const ctx = await chromium.launchPersistentContext('/tmp/shots/profileGMULTI',{headless:false,
...
await page.screenshot({path:`${OUT}/gmulti.png`});
await ctx.close();
