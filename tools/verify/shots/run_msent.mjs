...
const mock = readFileSync('/tmp/shots/mock_msent.html','utf8');

const ctx = await chromium.launchPersistentContext('/tmp/shots/profileMSENT',{headless:false,
...
await popup.click('.mode-btn[data-id="memorize_sentence"]');
await popup.waitForTimeout(150);
await popup.click('#btnRun');

await page.bringToFront();
await page.waitForTimeout(6000);
await page.screenshot({path:`${OUT}/msent-solving.png`});
