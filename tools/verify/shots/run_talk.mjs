...
const mock = readFileSync('/tmp/shots/mock_talk.html','utf8');

const ctx = await chromium.launchPersistentContext('/tmp/shots/profileTALK',{headless:false,
...
await page.screenshot({path:`${OUT}/talk-solving.png`});
