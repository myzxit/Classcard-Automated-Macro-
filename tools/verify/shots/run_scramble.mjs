...
const mock = readFileSync('/tmp/shots/mock_scramble.html','utf8');

const ctx = await chromium.launchPersistentContext('/tmp/shots/profileSCR',{headless:false,
...
await popup.click('.mode-btn[data-id="scramble"]');
await popup.waitForTimeout(150);
await popup.click('#btnRun');

await page.bringToFront();
await page.waitForTimeout(6000);
await page.screenshot({path:`${OUT}/scr-solving.png`});
