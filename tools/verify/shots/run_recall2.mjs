...
const mock = readFileSync('/tmp/shots/mock_recall2.html','utf8');

const ctx = await chromium.launchPersistentContext('/tmp/shots/profileRECALL2',{headless:false,
...
await popup.click('.mode-btn[data-id="recall"]');
await popup.waitForTimeout(150);
await popup.click('#btnRun');

await page.bringToFront();
await page.waitForTimeout(6000);
await page.screenshot({path:`${OUT}/recall2-solving.png`});
